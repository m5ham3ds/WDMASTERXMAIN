...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupDarkModeToggle()
        setupRouterList()
        setupAddRouterDialog()        loadSettings()
    }
    ...
    private fun setupRouterList() {
        ...
        routerRepository.allRoutersFlow.onEach { routers ->
    ...
    private fun showEditRouterDialog(router: Router?) {
        val view = LayoutInflater.from(requireContext())
            .inflate(com.wdmaster.app.R.layout.dialog_router_edit, binding.root, false)
        
        val etName = view.findViewById<com.google.android.material.textfield.TextInputEditText>(com.wdmaster.app.R.id.etName)        val etPrefix = view.findViewById<com.google.android.material.textfield.TextInputEditText>(com.wdmaster.app.R.id.etPrefix)
        val etChipset = view.findViewById<com.google.android.material.textfield.TextInputEditText>(com.wdmaster.app.R.id.etChipset)
